...
interface EmployeeExistsDialogProps {
  open: boolean
...
export function EmployeeExistsDialog({
  open,
  existingUser,
  errorMessage,
  isSubmitting,
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle>Сотрудник с таким номером телефона уже существует, вот его данные:</DialogTitle>
      <DialogContent>
        {existingUser ? (
